...
do
	...
	do
		...
		function Library:Window(Options)
			...
			version.FontFace = Font.new(Font:GetRegistry("menu_plex"))
		...
		function Pages:Section(Options)
			...
			LeftTitle.FontFace = Font.new(Font:GetRegistry("menu_plex"))
			...
			RightTitle.FontFace = Font.new(Font:GetRegistry("menu_plex"))
		...
		function Sections:Toggle(Options)
			...
			function Toggle:Keybind(Options)
				...
				Mode.FontFace = Font.new(Font:GetRegistry("menu_plex"))
		...
		function Sections:Slider(Options)
			...
			plus.FontFace = Font.new(Font:GetRegistry("menu_plex"))
			...
			minus.FontFace = Font.new(Font:GetRegistry("menu_plex"))
		...
		function Sections:Textbox(Options)
			...
			TextBox.FontFace = Font.new(Font:GetRegistry("menu_plex"))
		...
		function Sections:Button(Options)
			...
			Textbutton.FontFace = Font.new(Font:GetRegistry("menu_plex"))
